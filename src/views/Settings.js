...
const Presets = [
  ...
  { id: 2, name: "5 Minutes 10 Slides", slides: 10, timeperslide: 30 },
]
let presetList = [];
...
const Settings = () => {
  ...
  const [currentSlideTime, setCurrentSlideTime] = useState(20);
  const [currentSlideNumber, setCurrentSlideNumber] = useState(20);
      ...
      <Form action="/presentation">
        ...
        <Form.Row>
          <Col>
            ...
            <Form.Control type="number" name="slideNumber" id="slideNumber" min="1" readOnly value={currentSlideNumber}></Form.Control>
          </Col>
          <Col>
            <Form.Label>Time per slide</Form.Label>
            <Form.Control type="number" name="slideTime" id="slideTime" min="1" readOnly value={currentSlideTime}></Form.Control>
          </Col>
        </Form.Row>
        <br></br>
